...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{text = 'Passages to Carlin, Ab\'Dendriel, Edron, Venore, Port Hope, Liberty Bay, tower of secret, Yalahar, Roshamuul, Krailos, Oramond and Svargrond.'}
}
...
addTravelKeyword('tower of secret', 50, Position(17474, 17390, 7))
...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Tower of Secret}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond} or {Edron}?'})
