...
monster.loot = {
	{name = "platinum coin", chance = 100000, maxCount = 81},
	{id = 28569, chance = 90000, maxCount = 8}, -- book page
	...
	{name = "spellweaver's robe", chance = 3050},
	{name = "wand of defiance", chance = 3050},
	{name = "haunted blade", chance = 5050},
	{name = "lightning legs", chance = 3050}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 80, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -744, radius = 3, effect = CONST_ME_ENERGYAREA, target = false},
