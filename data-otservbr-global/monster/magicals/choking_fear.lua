...
monster.attacks = {
	...
	-- poison
	{name ="condition", type = CONDITION_POISON, interval = 2000, chance = 18, minDamage = -700, maxDamage = -900, length = 5, spread = 3, effect = CONST_ME_HITBYPOISON, target = false},
	...
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_DEATHDAMAGE, minDamage = -250, maxDamage = -666, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true}
}
