...
monster.loot = {
	{id = 28569, chance = 100000, maxCount = 5}, -- book page
	...
	{name = "lightning legs", chance = 2050},
	{name = "spellbook of warding", chance = 3050},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -299, maxDamage = -550},
	{name ="combat", interval = 1000, chance = 65, type = COMBAT_ENERGYDAMAGE, minDamage = -450, maxDamage = -555, radius = 3, effect = CONST_ME_ENERGYAREA, target = false}
}
