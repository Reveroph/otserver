...
monster.loot = {
	...
	{name = "green crystal shard", chance = 30666},
	{name = "cyan crystal fragment", chance = 30340},
	{id = 3039, chance = 2390, maxCount = 1}, -- red gem
	{name = "violet gem", chance = 10000, maxCount = 3},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -550, length = 4, spread = 0, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -630, range = 3, radius = 3, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -700, range = 7, shootEffect = CONST_ANI_EARTHARROW, target = true},
}
