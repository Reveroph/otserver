...
monster.loot = {
	...
	{name = "book page", chance = 100000, maxCount = 5},
	...
	{name = "fire axe", chance = 9050},
	{name = "soul orb", chance = 260, maxCount = 5},
	{name = "spellbook of warding", chance = 2050},
	{name = "wand of inferno", chance = 2050},
	{name = "fire sword", chance = 2050},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 45, type = COMBAT_FIREDAMAGE, minDamage = -400, maxDamage = -775, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}
