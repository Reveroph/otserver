...
monster.attacks = {
	...
	-- bleed
	{name ="condition", type = CONDITION_BLEEDING, interval = 2000, chance = 18, minDamage = -500, maxDamage = -1000, radius = 3, target = false},
	...
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -800, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false}
}
