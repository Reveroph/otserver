...
monster.loot = {
	{name = "violet crystal shard", chance = 90000, maxCount = 4},
	...
	{name = "blue crystal splinter", chance = 25000, maxCount = 4},
	{name = "cyan crystal fragment", chance = 25000, maxCount = 4},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -100, maxDamage = -680},
	{name ="combat", interval = 2000, chance = 65, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -888, range = 7, shootEffect = CONST_ANI_ENERGY, target = false},
	{name ="combat", interval = 2000, chance = 60, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -985, radius = 3, effect = CONST_ME_ENERGYAREA, target = false}
}
