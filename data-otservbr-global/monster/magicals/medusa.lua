...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_EARTHDAMAGE, minDamage = -380, maxDamage = -630, length = 8, spread = 3, effect = CONST_ME_CARNIPHILA, target = false},
