...
monster.attacks = {
	...
	{name ="fire wave", interval = 2000, chance = 17, minDamage = -350, maxDamage = -500, length = 1, spread = 0, target = true},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -666, radius = 4, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -667, range = 1, shootEffect = CONST_ANI_FIRE, target = false},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -667, length = 6, spread = 3, effect = CONST_ME_HOLYAREA, target = false}
}
