...
monster.loot = {
	{name = "platinum coin", chance = 89960, maxCount = 90},
	{name = "book page", chance = 100000, maxCount = 15},
	{name = "demonic essence", chance = 30000, maxCount = 5},
	{name = "flask of demonic blood", chance = 3000, maxCount = 3},
	{name = "small amethyst", chance = 35000, maxCount = 4},
...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -999, range = 7, shootEffect = CONST_ANI_FLAMMINGARROW, effect = CONST_ME_HITBYFIRE, target = false},
	...
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -400, maxDamage = -999, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}
