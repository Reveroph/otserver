...
monster.attacks = {
	...
	{name ="arachnophobicawavedice", interval = 2000, chance = 20, minDamage = -250, maxDamage = -888, target = false},
	{name ="arachnophobicawaveenergy", interval = 2000, chance = 20, minDamage = -250, maxDamage = -599, target = false},
