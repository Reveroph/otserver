local mType = Game.createMonsterType("Teste Fire")
local monster = {}
monster.description = "Teste Fire"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -100, range = 1, target = false}
}
