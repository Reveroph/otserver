...
monster.loot = {
	...
	{id = 3035, chance = 73500, maxCount = 4}, -- platinum coin
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_ENERGYDAMAGE, minDamage = -125, maxDamage = -300, range = 7, shootEffect = CONST_ANI_ENERGY, target = false},
