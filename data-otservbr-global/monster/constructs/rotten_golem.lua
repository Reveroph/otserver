...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -350, maxDamage = -900, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYAREA, target = true},
	{name ="combat", interval = 2000, chance = 55, type = COMBAT_EARTHDAMAGE, minDamage = -450, maxDamage = -1200, radius = 7, effect = CONST_ME_BIGPLANTS, target = false},
