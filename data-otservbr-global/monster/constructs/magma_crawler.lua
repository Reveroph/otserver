...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -505, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -380, maxDamage = -735, radius = 3, effect = CONST_ME_HITBYFIRE, target = false},
