...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_PHYSICALDAMAGE, minDamage = -444, maxDamage = -1210, radius = 5, effect = CONST_ME_SMOKE, target = false},
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_PHYSICALDAMAGE, minDamage = -445, maxDamage = -1210, radius = 3, effect = CONST_ME_BATS, target = false}
}
