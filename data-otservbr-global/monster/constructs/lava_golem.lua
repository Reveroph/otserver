...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -950, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -220, maxDamage = -560, radius = 4, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -280, maxDamage = -1000, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}
