...
monster.loot = {
	...
	{id = 3033, chance = 1540, maxCount = 3}, -- small amethyst
	{id = 3028, chance = 1388, maxCount = 3}, -- small diamond
	{id = 3032, chance = 7351, maxCount = 2}, -- small emerald
	{id = 3030, chance = 8114, maxCount = 5}, -- small ruby
	{id = 9057, chance = 1114, maxCount = 3}, -- small topaz
	{id = 3041, chance = 874}, -- blue gem
	{id = 6299, chance = 260}, -- death ring
	{id = 6499, chance = 3300}, -- demonic essence
	{id = 8043, chance = 220}, -- focus cape
	{id = 21974, chance = 8777}, -- golden lotus brooch
	...
	{id = 21975, chance = 8500}, -- peacock feather fan
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -100, maxDamage = -333},
	{name ="combat", interval = 2000, chance = 27, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -333, range = 7, target = false},
	{name ="firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 2000, chance = 27, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -400, length = 8, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
