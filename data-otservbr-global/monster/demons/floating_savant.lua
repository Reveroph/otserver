...
monster.loot = {
	{name = "small enchanted ruby", chance = 40000, maxCount = 5},
	{name = "red crystal fragment", chance = 20000, maxCount = 2},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_FIREDAMAGE, minDamage = -390, maxDamage = -680, range = 7, shootEffect = CONST_ANI_FIRE, target = false},
