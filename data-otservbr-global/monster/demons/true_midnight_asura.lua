...
monster.loot = {
	...
	{id = 3027, chance = 20000}, -- black pearl
	{id = 6558, chance = 2000}, -- flask of demonic blood
	{id = 6499, chance = 22100}, -- demonic essence
	{id = 3028, chance = 8000, maxCount = 3}, -- small diamond
	{id = 3032, chance = 9000, maxCount = 3}, -- small emerald
	{id = 3030, chance = 6500, maxCount = 3}, -- small ruby
	{id = 3029, chance = 5800, maxCount = 3}, -- small sapphire
	{id = 9057, chance = 5080, maxCount = 3}, -- small topaz
	{id = 239, chance = 700}, -- great health potion
	{id = 3026, chance = 660}, -- white pearl
	{id = 7404, chance = 4300}, -- assassin dagger
	{id = 3041, chance = 3420}, -- blue gem
	{id = 3567, chance = 3400}, -- blue robe
	{id = 9058, chance = 4000}, -- gold ingot
	{id = 21974, chance = 6000}, -- golden lotus brooch
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -777},
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -100, maxDamage = -800, length = 8, spread = 3, effect = CONST_ME_BLACKSMOKE, target = false},
