...
monster.loot = {
	...
	{id = 3033, chance = 21000, maxCount = 3}, -- small amethyst
	{id = 3028, chance = 30000, maxCount = 3}, -- small diamond
	{id = 3032, chance = 30000, maxCount = 3}, -- small emerald
	{id = 3030, chance = 35000, maxCount = 3}, -- small ruby
	{id = 9057, chance = 28000, maxCount = 3}, -- small topaz
	{id = 3041, chance = 4000}, -- blue gem
	{id = 6299, chance = 4600}, -- death ring
	{id = 6499, chance = 43000}, -- demonic essence
	{id = 8043, chance = 5200}, -- focus cape
	{id = 21974, chance = 8000}, -- golden lotus brooch
	{id = 826, chance = 4000}, -- magma coat
	{id = 3078, chance = 400}, -- mysterious fetish
	{id = 3574, chance = 400}, -- mystic turban
	{id = 21981, chance = 4000}, -- oriental shoes
	...
	{id = 8074, chance = 4000}, -- spellbook of mind control
	{id = 3071, chance = 4000} -- wand of inferno
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -150, maxDamage = -680},
	...
	{name ="combat", interval = 1000, chance = 36, type = COMBAT_FIREDAMAGE, minDamage = -120, maxDamage = -850, length = 1, spread = 0, effect = CONST_ME_HITBYFIRE, target = false},
