...
monster.loot = {
	...
	{id = 3035, chance = 93000, maxCount = 6}, -- platinum coin
	{id = 7368, chance = 2000, maxCount = 2}, -- assassin star
	{id = 3027, chance = 2000}, -- black pearl
	{id = 6558, chance = 2000}, -- flask of demonic blood
	{id = 6499, chance = 9000}, -- demonic essence
	{id = 3028, chance = 3500, maxCount = 3}, -- small diamond
	{id = 3032, chance = 2264, maxCount = 3}, -- small emerald
	{id = 3030, chance = 1988, maxCount = 3}, -- small ruby
	{id = 3029, chance = 4800, maxCount = 3}, -- small sapphire
	{id = 9057, chance = 3211, maxCount = 3}, -- small topaz
	{id = 239, chance = 700}, -- great health potion
	{id = 3026, chance = 4100}, -- white pearl
	{id = 7404, chance = 840}, -- assassin dagger
	{id = 3041, chance = 666}, -- blue gem
	{id = 3567, chance = 850}, -- blue robe
	{id = 9058, chance = 1055}, -- gold ingot
	{id = 21974, chance = 9740}, -- golden lotus brooch
	{id = 3070, chance = 300}, -- moonlight rod
	{id = 3069, chance = 90}, -- necrotic rod
	{id = 21981, chance = 80}, -- oriental shoes
	{id = 21975, chance = 11030}, -- peacock feather fan
	...
	{id = 8082, chance = 487}, -- underworld rod
	{id = 3037, chance = 699} -- yellow gem
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -80, maxDamage = -400},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -90, range = 7, target = false},
	{name ="firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -210, maxDamage = -422, length = 8, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
