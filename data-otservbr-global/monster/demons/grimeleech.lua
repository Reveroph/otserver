...
monster.loot = {
	...
	{name = "rift crossbow", chance = 1500},
	{name = "steel boots", chance = 1500},
	{name = "rift shield", chance = 1500},
	{name = "rift lance", chance = 1500},
	{name = "rift bow", chance = 1500},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -300, maxDamage = -850},
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -900, range = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -560, maxDamage = -980, length = 8, spread = 3, target = false},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_DEATHDAMAGE, minDamage = -600, maxDamage = -980, radius = 4, target = false},
