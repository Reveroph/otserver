local mType = Game.createMonsterType("Teste Holy")
local monster = {}
monster.description = "Teste Holy"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_HOLYDAMAGE, minDamage = -100, maxDamage = -100, range = 1, target = false}
}
