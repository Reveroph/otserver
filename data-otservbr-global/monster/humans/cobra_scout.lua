...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 27, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -520, radius = 4, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_GREEN_RINGS, target = true},
