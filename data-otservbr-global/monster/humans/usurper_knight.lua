...
monster.attacks = {
	...
	{name ="combat", interval = 6000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -735, radius = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 6000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -150, maxDamage = -700, length = 4, spread = 0, effect = CONST_ME_ICEATTACK, target = false},
