...
monster.loot = {
	...
	{name = "springsprout rod", chance = 4955},
	{id = 3059, chance = 2350}, -- spellbook
	{name = "spellbook of warding", chance = 3390},
	{name = "gold ring", chance = 2999},
	{name = "butterfly ring", chance = 3000},
	{name = "human teeth", chance = 5050}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -300},
	{name ="combat", interval = 2700, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -650, range = 2, radius = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 70, type = COMBAT_EARTHDAMAGE, minDamage = -350, maxDamage = -510, range = 5, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_POISONAREA, target = true},
}
