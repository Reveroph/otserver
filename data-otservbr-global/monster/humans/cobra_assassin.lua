...
monster.loot = {
	...
	{name = "green crystal shard", chance = 6900},
	{name = "gold ingot", chance = 4444},
	{name = "green crystal fragment", chance = 9350},
	{name = "red crystal fragment", chance = 10500},
	{name = "cobra crest", chance = 7750},
	{id = 3307, chance = 7750}, -- scimitar
	{id = 22194, chance = 45000}, -- opal
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_PHYSICALDAMAGE, minDamage = -333, maxDamage = -535, radius = 4, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 2000, chance = 24, type = COMBAT_PHYSICALDAMAGE, minDamage = -280, maxDamage = -535, length = 5, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}
