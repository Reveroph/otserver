local mType = Game.createMonsterType("Teste Lifedrain")
local monster = {}
monster.description = "Teste Lifedrain"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -100, range = 1, target = false}
	--{name ="combat", interval = 2000, chance = 100, type = COMBAT_PHYSICALDAMAGE, minDamage = 100, maxDamage = 100, range = 1, target = false}
}
