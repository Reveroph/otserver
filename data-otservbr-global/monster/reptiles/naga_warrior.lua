...
monster.loot = {
	...
	{name = "violet crystal shard", chance = 10500},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -50, maxDamage = -560},
	{name ="combat", interval = 3000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -380, effect = CONST_ME_YELLOWSMOKE, target = true},
	{name ="combat", interval = 4000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -222, radius = 4, effect = CONST_ME_DRAWBLOOD, target = false},
}
