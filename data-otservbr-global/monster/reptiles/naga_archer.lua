...
monster.loot = {
	...
	{name = "crystal crossbow", chance = 4030},
...
monster.attacks = {
    {name ="combat", interval = 2000, chance = 100, minDamage = -10, maxDamage = -340, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_PURPLEENERGY, target = true},
    {name ="nagadeath", interval = 2000, chance = 22, target = false, minDamage = -230, maxDamage = -350},
    {name ="nagadeathattack", interval = 2000, chance = 33, target = true, minDamage = -150, maxDamage = -400},
}
