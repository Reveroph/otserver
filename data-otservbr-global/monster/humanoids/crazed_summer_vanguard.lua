...
monster.loot = {
	...
	{name = "magma amulet", chance = 11110},
	{name = "wand of dragonbreath", chance = 4444},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -444, maxDamage = -710, length = 3, spread = 0, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -400, maxDamage = -555, range = 7, shootEffect = CONST_ANI_FIRE, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -333, maxDamage = -350, radius = 5, effect = CONST_ME_EXPLOSIONAREA, target = true}
}
