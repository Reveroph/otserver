...
monster.loot = {
	...
	{name = "warrior helmet", chance = 3350},
	...
	{name = "green crystal shard", chance = 6150},
	{name = "green crystal splinter", chance = 8887},
	{name = "brown crystal splinter", chance = 8888, maxCount = 2},
	{name = "red crystal fragment", chance = 8887},
	{name = "drill bolt", chance = 3690, maxCount = 5}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -80, maxDamage = -501},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -485, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false},
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -315, range = 7, radius = 3, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_EXPLOSIONHIT, target = true},
