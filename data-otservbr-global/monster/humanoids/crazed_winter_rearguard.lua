...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_ICEDAMAGE, minDamage = -550, maxDamage = -777, radius = 3, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2000, chance = 16, type = COMBAT_ICEDAMAGE, minDamage = -444, maxDamage = -800, range = 7, shootEffect = CONST_ANI_ICE, target = false}
}
