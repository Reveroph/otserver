...
monster.loot = {
	...
	{name = "violet crystal shard", chance = 2500},
	{name = "small enchanted ruby", chance = 7120},
	{name = "red crystal fragment", chance = 4501},
	...
	{name = "wood cape", chance = 5000},
	{name = "small diamond", chance = 6130},
	{name = "yellow gem", chance = 4850},
	{name = "crystal crossbow", chance = 1050}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -210, maxDamage = -530},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -270, maxDamage = -710, length = 3, spread = 0, effect = CONST_ME_FIREAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -380, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = true},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -350, radius = 5, effect = CONST_ME_EXPLOSIONAREA, target = true}
}
