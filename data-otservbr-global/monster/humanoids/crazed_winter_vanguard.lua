...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_ICEDAMAGE, minDamage = -200, maxDamage = -390, radius = 5, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2000, chance = 33, type = COMBAT_ICEDAMAGE, minDamage = -240, maxDamage = -390, length = 4, spread = 3, effect = CONST_ME_GIANTICE, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -250, maxDamage = -390, range = 7, shootEffect = CONST_ANI_ICE, target = false}
}
