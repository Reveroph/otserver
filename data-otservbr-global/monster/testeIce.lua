local mType = Game.createMonsterType("Teste Ice")
local monster = {}
monster.description = "Teste Ice"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_ICEDAMAGE, minDamage = -100, maxDamage = -100, range = 1, target = false}
}
