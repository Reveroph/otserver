...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -888, range = 1, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 1500, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -380, maxDamage = -900, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false}
}
