...
monster.loot = {
	...
	{name = "small amethyst", chance = 45000, maxCount = 3},
	{name = "assassin star", chance = 24670, maxCount = 10},
	{name = "small diamond", chance = 45000, maxCount = 3},
	{name = "small ruby", chance = 40000, maxCount = 3},
	{name = "small emerald", chance = 25000, maxCount = 3},
	{name = "onyx arrow", chance = 14480, maxCount = 15},
	{name = "small topaz", chance = 28000, maxCount = 3},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -666},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -500, radius = 2, effect = CONST_ME_GROUNDSHAKER, target = false},
	{name ="combat", interval = 2000, chance = 28, type = COMBAT_HOLYDAMAGE, minDamage = -290, maxDamage = -360, length = 5, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}
