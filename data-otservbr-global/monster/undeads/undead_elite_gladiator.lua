...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 80, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -550, range = 7, shootEffect = CONST_ANI_WHIRLWINDSWORD, target = false},
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -750, range = 5, radius = 3, effect = CONST_ME_HITAREA, target = false}
}
