...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -350, maxDamage = -600, range = 5, shootEffect = CONST_ANI_HUNTINGSPEAR, target = false},
	{name ="combat", interval = 4000, chance = 16, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -430, range = 5, shootEffect = CONST_ANI_LARGEROCK, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -550, maxDamage = -750, radius = 3, effect = CONST_ME_POFF, target = false}
}
