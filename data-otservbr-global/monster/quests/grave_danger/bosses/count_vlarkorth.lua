...
monster.loot = {
	{name = "platinum coin", minCount = 1, maxCount = 50, chance = 100000},
	{name = "crystal coin", minCount = 0, maxCount = 2, chance = 100000},
	...
	{name = "silver token", minCount = 0, maxCount = 2, chance = 25000},
	...
	{name = "terra helmet", chance = 1500},
	{name = "final judgement", chance = 400},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -600, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_MANADRAIN, minDamage = -50, maxDamage = -100, length = 7, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false},
