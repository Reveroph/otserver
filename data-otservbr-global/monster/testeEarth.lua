local mType = Game.createMonsterType("Teste Earth")
local monster = {}
monster.description = "Teste Earth"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -100, range = 1, target = false}
}
