...
monster.loot = {
	...
	{name = "platinum coin", chance = 88400, maxCount = 5},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_FIREDAMAGE, minDamage = -240, maxDamage = -520, length = 4, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false}
}
