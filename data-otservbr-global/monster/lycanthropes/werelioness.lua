...
monster.loot = {
	...
	{name = "magma legs", chance = 2350},
	{name = "crown helmet", chance = 500},
	{name = "white silk flower", chance = 2000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -250, maxDamage = -300, length = 4, spread = 1, effect = CONST_ME_FIREAREA, target = false}
}
