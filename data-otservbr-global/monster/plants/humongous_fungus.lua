...
monster.loot = {
	...
	{name = "platinum coin", chance = 999900, maxCount = 13},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 29, type = COMBAT_EARTHDAMAGE, minDamage = -180, maxDamage = -777, range = 7, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_SMALLPLANTS, target = false},
