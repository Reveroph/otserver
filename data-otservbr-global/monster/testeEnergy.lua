local mType = Game.createMonsterType("Teste Energy")
local monster = {}
monster.description = "Teste Energy"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -100, range = 1, target = false}
}
