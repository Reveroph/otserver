...
monster.loot = {
	...
	{name = "small enchanted ruby", chance = 100000},
	{name = "violet gem", chance = 7750},
	{name = "lump of dirt", chance = 10190},
	{name = "tunnel tyrant head", chance = 35000},
	{name = "tunnel tyrant shell", chance = 35000},
	{name = "green gem", chance = 5050},
	{name = "blue gem", chance = 5050},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 27, type = COMBAT_DEATHDAMAGE, minDamage = -70, maxDamage = -444, range = 3, length = 6, spread = 3, effect = CONST_ME_MORTAREA, target = false},
