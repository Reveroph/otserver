...
monster.loot = {
	{name = "deepworm jaws", chance = 44010},
	...
	{name = "green crystal shard", chance = 40000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_EARTHDAMAGE, minDamage = -190, maxDamage = -777, range = 7, length = 6, spread = 2, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -200, maxDamage = -850, length = 3, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}
