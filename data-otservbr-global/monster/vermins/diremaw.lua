...
monster.loot = {
	...
	{name = "blue crystal shard", chance = 11111},
	{name = "violet crystal shard", chance = 11111},
	{name = "green crystal shard", chance = 11111},
...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -444, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -399, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POFF, target = true},
	-- poison
	{name ="condition", type = CONDITION_POISON, interval = 2000, chance = 21, minDamage = -250, maxDamage = -480, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false}
}
