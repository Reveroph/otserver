...
monster.loot = {
	...
	{name = "violet gem", chance = 6940, maxCount = 4},
	{name = "violet crystal shard", chance = 5410},
	{name = "doublet", chance = 5060},
	{name = "green crystal shard", chance = 50000},
	{name = "belted cape", chance = 3760},
	{name = "afflicted strider head", chance = 20000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -550, maxDamage = -800, range = 3, shootEffect = CONST_ANI_POISON, target = true},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -650, maxDamage = -999, radius = 5, effect = CONST_ME_GROUNDSHAKER, target = false}
}
