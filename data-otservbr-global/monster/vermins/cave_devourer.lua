...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -400, range = 3, length = 6, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -190, maxDamage = -405, range = 3, length = 6, spread = 3, effect = CONST_ME_HITBYFIRE, target = false},
