...
monster.loot = {
	{name = "gold coin", chance = 10000, maxCount = 10},
	...
	{name = "small enchanted emerald", chance = 33500, maxCount = 5},
	{name = "small enchanted amethyst", chance = 45000, maxCount = 5},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_EARTHDAMAGE, minDamage = -5, maxDamage = -400, range = 7, shootEffect = CONST_ANI_POISON, target = true},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -30, maxDamage = -350, range = 7, shootEffect = CONST_ANI_DEATH, target = true},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -70, maxDamage = -444, range = 3, length = 3, spread = 3, effect = CONST_ME_MORTAREA, target = false},
