...
monster.loot = {
	...
	{name = "small diamond", chance = 10200, maxCount = 4},
	{name = "small topaz", chance = 10200, maxCount = 4},
	{id = 282, chance = 900, maxCount = 4}, -- giant shimmering pearl (brown)
	{name = "blue gem", chance = 9050, maxCount = 4},
	{name = "terra boots", chance = 8050, maxCount = 4},
	{name = "terra hood", chance = 9800, maxCount = 4},
	...
	{name = "terra legs", chance = 6050, maxCount = 4},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -285, maxDamage = -480, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, effect = CONST_ME_GREEN_RINGS, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -260, maxDamage = -505, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true}
}
